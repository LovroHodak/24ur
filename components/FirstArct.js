...
export default function FirstArct({ navigation }) {
  return (
    <ScrollView style={styles.container}>
      ...
      <Text style={{ margin: 10, fontSize: 16, padding: 5 }}>
        Epidemija, kot ugotavljajo na IJS, predvidoma stagnira. <Text style={{ fontStyle: "italic" }}>"Potrudimo se
        krivulje obrniti čim bolj strmo navzdol, ker nas dohitevajo in verjetno
        že prehitevajo novi bolj kužni sevi, ki se v trenutnih pogojih hitro
        razmnožujejo,"</Text> izpostavljajo. Po njihovih besedah je pomembno, da
        zmanjšamo število hospitaliziranih, ocenjeno reprodukcijsko število pa
        je spet nekoliko naraslo in znaša 1 (dan prej 0,92).
      </Text>
    </ScrollView>
  );
}
